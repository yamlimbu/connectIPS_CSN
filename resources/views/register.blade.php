                        ...
                        <div class="form-row">
                            @foreach ($data->eventCategories as $category)
                                <div class="col-md-12">
                                    ...
                                    <span
                                        class="text-danger">{{ $errors->first('event_category_ticket_prices_ids') }}</span>
                                                            ...
                                                            @if ($earlyBirdPrice)
                                                                <div class="form-group col-lg-12">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        id="ticket_{{ $ticket->id }}_early_bird"
                                                                        value="{{ $earlyBirdPrice->id }}"
                                                                        {{ $oldPriceId == $earlyBirdPrice->id ? 'checked' : '' }}>
