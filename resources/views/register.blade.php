    ...
    <div class="container">
        ...
        <div class="bg-light mb-5">
            <form method="POST" action="{{ route('event_register') }}">
                ...
                <div class="card">
                    <div class="card-header fw-bold p-2 p-md-3">Register</div>
                    <div class="card-body p-2 p-md-3">
                        <div class="row mb-4">
                            <div class="form-group col-lg-4 mb-2 mb-md-4">
                    ...
                    <div class="card-footer text-end border-0">
                        <button type="submit" name="registration_form" value="submitted" class="btn btn-primary">Register</button>
                    </div>
                </div>
            </form>
        </div>
